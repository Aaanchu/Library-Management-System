    ...
    <div class="col-md-4">
        <form action="update.php" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $FIRST_NAME;?>"name="FIRST_NAME"></div>
                <div class="form-group">
                <label>LAST_NAME:</label>
                <input type="text" class="form-control" value="<?php echo $LAST_NAME;?>"name="LAST_NAME"></div>
                <div class="form-group">
                <label>Email:</label>
                <input type="text" class="form-control" value="<?php echo $email;?>"name="email"></div>
                <div class="form-group">
                <label>Mobile:</label>
                <input type="text" class="form-control" value="<?php echo $mobile;?>"name="mobile"></div>
                <div class="form-group">
                <label>Address:</label>
                <textarea rows="3" cols="40" name="address" class="form-control"><?php echo $address;?></textarea></div>
                <div class="form-group">
                <label>Pincode:</label>
                <input type="text" class="form-control" value="<?php echo $pincode;?>"name="pincode"></div>
