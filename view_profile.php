    ...
    <div class="col-md-4">
        <form>
            <div class="form-group">
                ...
                <div class="form-group">
                <label>Address:</label>
                <textarea rows="3" cols="40" disabled="" class="form-control"><?php echo $address;?></textarea></div>
                <div class="form-group">
                <label>Pincode:</label>
                <input type="text" class="form-control" value="<?php echo $pincode;?>"disabled></div>
    </form>
            </div>
    <div class="col-md-4"></div>
</div>
