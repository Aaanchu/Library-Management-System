 ...
 <?php
        ...
        while($row=mysqli_fetch_assoc($query_run)){
            ...
            <tr>
                ...
                <td>
                    <button class="btn" name=""><a href="edit_cat.php?cd=<?php echo $row['cat_id'];?>">Edit</a></button>
                    <button class="btn" name=""><a href="delete_cat.php?cd=<?php echo $row['cat_id'];?>">Delete</a></button>
                </td>
            </tr>
            <?php
        }
